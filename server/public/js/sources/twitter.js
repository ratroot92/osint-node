...
function populateTable() {
  $.get("http://192.168.18.20:8000/core/get_twitter_targets", function(data) {
...
$(document).ready(function() {
    ...
    if (author_account_name == "") {
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          var base_url = "https://www.twitter.com/" + id;
  ...
  $("#submitBTN").on("click", function(e) {
    ...
    if (valid == false) {
      ...
      let expired_on = $("#datepicker-13").val();
      let interval = $("#interval").val();
      let tweets_type = $("#tweets_type").val();
      ...
      fetch("http://192.168.18.20:8000/core/add_twitter_target/", {
        method: "POST",
        cache: "no-cache",
        headers: {
        ...
        if (info.status == "200") {
          ...
          $("#smart_search_err")
            .empty()
            .append("New Twitter Author Target  Successfull Added ");
          $("#smart_search_err").fadeOut(3000);
        } else {
          clearForm();
...
$(document).ready(function() {
  $.get("http://192.168.18.20:8000/core/add_twitter_target/", function(data) {
    var array = data.twitter_target_form.intervals;
    var array2 = data.twitter_target_form.tweets_type;
    //  console.log(array)
