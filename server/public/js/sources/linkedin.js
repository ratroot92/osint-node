...
function populateTable() {
  $.get("http://192.168.18.20:8000/core/get_linkedin_targets", function(data) {
...
$(document).ready(function() {
  ...
  $("#submitBTN").on("click", function(e) {
    ...
    if (valid == false) {
      ...
      fetch("http://192.168.18.20:8000/core/add_linkedin_target/", {
        method: "POST",
        cache: "no-cache",
        headers: {
...
$(document).ready(function() {
  $.get("http://192.168.18.20:8000/core/add_linkedin_target/", function(data) {
